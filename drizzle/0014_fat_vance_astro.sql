...
INSERT INTO `__new_sport_league_weeks`("id", "season_id", "name", "start_time", "end_time", "espn_events_ref", "type", "manual", "pick_lock_time", "created_at", "updated_at") SELECT "id", "season_id", "name", "start_time", "end_time", "espn_events_ref", "type", "manual", "pick_lock_time", "created_at", "updated_at" FROM `sport_league_weeks`;--> statement-breakpoint
