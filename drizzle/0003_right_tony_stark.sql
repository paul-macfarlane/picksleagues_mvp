...
INSERT INTO `__new_picks_league_picks`("id", "user_id", "league_id", "sport_league_week_id", "sport_league_game_id", "type", "team_id", "spread", "created_at", "updated_at") SELECT "id", "user_id", "league_id", "sport_league_week_id", "sport_league_game_id", "type", "team_id", "spread", "created_at", "updated_at" FROM `picks_league_picks`;--> statement-breakpoint
