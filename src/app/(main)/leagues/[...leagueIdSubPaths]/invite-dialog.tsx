...
import { LeagueInviteFormSchema } from "@/models/leagues";
import { zodResolver } from "@hookform/resolvers/zod";
import { Form } from "@/components/ui/form";
import { z } from "zod";
import { useFormState } from "react-dom";
import { leagueInviteFormAction } from "@/app/(main)/leagues/[...leagueIdSubPaths]/invite-action";

type FormSchema = z.infer<typeof LeagueInviteFormSchema>;
...
export function InviteDialog({ leagueId }: { leagueId: string }) {
  ...
  const [formState, formAction] = useFormState(leagueInviteFormAction, {});
  const form = useForm<FormSchema>({
    resolver: zodResolver(LeagueInviteFormSchema),
  });
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          form.handleSubmit(async () => {
            const actionResponse = await leagueInviteFormAction(
              formState,
